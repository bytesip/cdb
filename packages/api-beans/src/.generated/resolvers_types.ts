...
export type GraphQLBaseTenantResolvers<
  ContextType = any,
  ParentType extends
    GraphQLResolversParentTypes['BaseTenant'] = GraphQLResolversParentTypes['BaseTenant'],
> = {
...
export type GraphQLTenantResolvers<
  ContextType = any,
  ParentType extends
    GraphQLResolversParentTypes['Tenant'] = GraphQLResolversParentTypes['Tenant'],
> = {
  id?: Resolver<GraphQLResolversTypes['ID'], ParentType, ContextType>;
  name?: Resolver<GraphQLResolversTypes['String'], ParentType, ContextType>;
  latitude?: Resolver<
...
export type GraphQLBaseUserResolvers<
  ContextType = any,
  ParentType extends
    GraphQLResolversParentTypes['BaseUser'] = GraphQLResolversParentTypes['BaseUser'],
> = {
...
export type GraphQLUserResolvers<
  ContextType = any,
  ParentType extends
    GraphQLResolversParentTypes['User'] = GraphQLResolversParentTypes['User'],
> = {
  id?: Resolver<GraphQLResolversTypes['ID'], ParentType, ContextType>;
  name?: Resolver<GraphQLResolversTypes['String'], ParentType, ContextType>;
  tenantId?: Resolver<GraphQLResolversTypes['ID'], ParentType, ContextType>;
...
> = {
  createTenant?: Resolver<
    GraphQLResolversTypes['Tenant'],
    ParentType,
    ContextType,
    RequireFields<GraphQLMutationCreateTenantArgs, 'input'>
  >;
  updateTenant?: Resolver<
    GraphQLResolversTypes['Tenant'],
    ParentType,
    ContextType,
    RequireFields<GraphQLMutationUpdateTenantArgs, 'id' | 'input'>
  >;
  deleteTenant?: Resolver<
    GraphQLResolversTypes['Boolean'],
    ParentType,
    ContextType,
    RequireFields<GraphQLMutationDeleteTenantArgs, 'id'>
  >;
};
...
> = {
  tenants?: Resolver<
    Array<GraphQLResolversTypes['Tenant']>,
    ParentType,
    ContextType
  >;
  tenant?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<GraphQLQueryTenantArgs, 'id'>
  >;
};
