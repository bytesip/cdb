...
import {
  GraphQLBaseTenant,
  GraphQLTenantInput,
  GraphQLTenantUpdateInput,
} from '../.generated/resolvers_types.ts';
...
let tenantFixtures: TenantEntity[] = Factory.define<TenantEntity>(
  ({sequence}) => ({
...
class TenantEntityManager extends BaseEntityManager<TenantEntity> {
  ...
  update(
    id: string,
    data: Convert<GraphQLTenantUpdateInput>
